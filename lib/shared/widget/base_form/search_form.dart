...
class SearchForm<T> extends StatefulWidget {
  final String? label;
  final bool? require;
  ...
  @override
  State<SearchForm<T>> createState() => _SearchFormState<T>();
}

class _SearchFormState<T> extends State<SearchForm<T>> {
        ...
        TypeAheadField<T>(
          ...
          builder: (context, controller, focusNode) {
            return TextFormField(
              ...
              initialValue: widget.initialValue?.isEmpty ?? true
                  ? null
                  : widget.initialValue,
