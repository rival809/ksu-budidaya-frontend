...
class DropdownSearchBase extends StatefulWidget {
  ...
  @override
  State<DropdownSearchBase> createState() => _DropdownSearchBase();
}

class _DropdownSearchBase extends State<DropdownSearchBase> {
  @override
        ...
        DropdownSearch(
            ...
            dropdownSearchDecoration: InputDecoration(
              ...
              fillColor: widget.enabled ?? true
                  ...
                  : widget.useBorder == false
                      ? neutralWhite
                      : gray200,
              hintText: widget.enabled ?? true ? widget.hint : "-",
          ...
          popupProps: PopupProps.menu(
            ...
            listViewProps: const ListViewProps(
              // Set the desired height for each ListTile in the ListView
              itemExtent: 32,
            ),
