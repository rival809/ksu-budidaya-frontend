...
import 'package:ksu_budidaya/module/transaksi/hist_bayar_hutang_anggota/widget/body_nota.dart';

class ContainerNotaHist extends StatefulWidget {
  final HistBayarHutangAnggotaController controller;

  const ContainerNotaHist({
    Key? key,
    required this.controller,
  }) : super(key: key);

  @override
  State<ContainerNotaHist> createState() => _ContainerNotaHistState();
}

class _ContainerNotaHistState extends State<ContainerNotaHist> {
  @override
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              if (controller.dataPenjualan.details?.isEmpty ?? true) {
                ...
                return BodyNotaHist(index: index, controller: controller);
              }
            },
          ),
          const SizedBox(
