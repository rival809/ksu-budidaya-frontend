...
class DialogPelunasanHutangDagang extends StatefulWidget {
  final DataDetailSupplier? data;

  const DialogPelunasanHutangDagang({
    Key? key,
    required this.data,
  }) : super(key: key);

  @override
  State<DialogPelunasanHutangDagang> createState() =>
      _DialogPelunasanHutangDagangState();
}

class _DialogPelunasanHutangDagangState
    extends State<DialogPelunasanHutangDagang> {
                  ...
                  child: BaseForm(
                    ...
                    onTap: () async {
                      DateTime? selectedDate = await initSelectedDate(
                        initValue: formatDateTimeNow(DateTime.now().toString()),
                      );
                    },
                    readOnly: true,
