...
class DetailTransaksiBodyPenjualan extends StatefulWidget {
  final int index;
  final PenjualanController controller;
  const DetailTransaksiBodyPenjualan({
    Key? key,
    required this.index,
  ...
  @override
  State<DetailTransaksiBodyPenjualan> createState() => _DetailTransaksiBodyPenjualanState();
}

class _DetailTransaksiBodyPenjualanState extends State<DetailTransaksiBodyPenjualan> {
