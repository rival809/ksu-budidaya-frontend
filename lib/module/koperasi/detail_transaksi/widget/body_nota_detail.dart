...
class BodyNotaDetail extends StatefulWidget {
  final int index;
  final DetailTransaksiController controller;
  const BodyNotaDetail({
    Key? key,
    required this.index,
  ...
  @override
  State<BodyNotaDetail> createState() => _BodyNotaDetailState();
}

class _BodyNotaDetailState extends State<BodyNotaDetail> {
