          ...
          build: (pw.Context context) => [
                ...
                pw.TableHelper.fromTextArray(
                  ...
                  data: rows
                      .map((row) => [
                            row.uraian ?? '',
                            formatMoneyDouble(row.neracaAwalD ?? 0),
                            formatMoneyDouble(row.neracaAwalK ?? 0),
                            formatMoneyDouble(row.neracaMutasiD ?? 0),
                            formatMoneyDouble(row.neracaMutasiK ?? 0),
                            formatMoneyDouble(row.neracaPercobaanD ?? 0),
                            formatMoneyDouble(row.neracaPercobaanK ?? 0),
                            formatMoneyDouble(row.neracaSaldoD ?? 0),
                            formatMoneyDouble(row.neracaSaldoK ?? 0),
                            formatMoneyDouble(row.neracaHasilUsahaD ?? 0),
                            formatMoneyDouble(row.neracaHasilUsahaK ?? 0),
                            formatMoneyDouble(row.neracaAkhirD ?? 0),
                            formatMoneyDouble(row.neracaAkhirK ?? 0),
                          ])
                      .toList(),
                  border: pw.TableBorder.all(),
